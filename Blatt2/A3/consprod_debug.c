//CONSPROD.C by Julian Ullrich, Memo to Myself:Compile with gcc -c queue.c -o queue.o  and gcc consprod_debug.c queue.o -o consprod_debug -lpthread
//Memo to Corrector?: This version has some useful debug messages showing the different Threads working, the clean version is consprod.c
